    ...
    if (!$stmt) {
        ...
        if ($role_result->num_rows > 0) {
            ...
            $stmt->bind_param("ssisssssssssssii", $firstname, $lastname, $age, $date_of_birth, $block_number, $street, $barangay, 
                $city, $country, $zipcode, $contact_number, $email, $username, $password, $role_id, $user_id);
...
$sql = "SELECT u.*, r.role_name, r.role_description FROM user_tb u JOIN role_tb r ON u.role_id = r.role_id WHERE user_id=?";
$stmt = $connection->prepare($sql);
    ...
    <div class="container my-5">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="role_name" id="role_name" class="form-control" required onchange="updateRoleDescription()">
